...
public class KWSChildren {
    ...
    public void authUser (String singleSignOnUrl, Activity activity, KWSChildrenLoginUserInterface listener) {
        authUserProcess.auth(singleSignOnUrl, activity, listener);
    }
