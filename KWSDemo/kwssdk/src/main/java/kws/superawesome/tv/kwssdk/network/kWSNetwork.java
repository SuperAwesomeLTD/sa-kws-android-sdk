...
public class kWSNetwork {
     ...
     * HTTP request
     */
    public void sendGET(Context context, String url, JSONObject query, JSONObject header, KWSNetworkInterface listener) {
     ...
     * HTTP request
     */
    public void sendPOST(Context context, String url, JSONObject query, JSONObject header, JSONObject body, KWSNetworkInterface listener) {
     ...
     * HTTP request
     */
    public void sendPUT(Context context, String url, JSONObject query, JSONObject header, JSONObject body, KWSNetworkInterface listener) {
     ...
     */
    private void sendRequest(Context context, String endpoint, final String method, JSONObject query, final JSONObject header, final JSONObject body, final KWSNetworkInterface listener) {
