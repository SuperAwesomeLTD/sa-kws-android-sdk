package kws.superawesome.tv.push;
...
public class PushRegisterPermission {
    ...
    public void isRegistered (){
        ...
        Log.d("SuperAwesome", "Checking if user has token in preferences " + token);
    ...
    public void register(String token) {
        Log.d("SuperAwesome", "Adding token to preferences: " + token);
    ...
    public void unregister() {
        String token = sharedPreferences.getString(kPushToken, null);
        Log.d("SuperAwesome", "Removing token from preferences: " + token);
